...
Preparing _$PreparingFromJson(Map<String, dynamic> json) => $checkedCreate(
      'Preparing',
      json,
      ($checkedConvert) {
        final val = Preparing(
...
InProgress _$InProgressFromJson(Map<String, dynamic> json) => $checkedCreate(
      'InProgress',
      json,
      ($checkedConvert) {
...
Failed _$FailedFromJson(Map<String, dynamic> json) => $checkedCreate(
      'Failed',
      json,
      ($checkedConvert) {
        final val = Failed(
